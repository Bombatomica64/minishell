...
/*   Updated: 2024/02/19 15:48:04 by lmicheli         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 * @param data The data structure containing the file and 
 * the commands to be executed
 * @param fd[2] The file descriptors to use and the fd to connect multiple pipes
